...
import static com.myshopmate.user.Config.BaseURL.KEY_PAYMENT_METHOD;
import static com.myshopmate.user.Config.BaseURL.KEY_PINCODE;
import static com.myshopmate.user.Config.BaseURL.KEY_REWARDS_POINTS;
import static com.myshopmate.user.Config.BaseURL.KEY_SOCITY_ID;
import static com.myshopmate.user.Config.BaseURL.KEY_SOCITY_NAME;
import static com.myshopmate.user.Config.BaseURL.KEY_WALLET_Ammount;
import static com.myshopmate.user.Config.BaseURL.PAYMENT_PAYPAL;
import static com.myshopmate.user.Config.BaseURL.PAYMENT_RAZORPZY;
import static com.myshopmate.user.Config.BaseURL.TOTAL_AMOUNT;
import static com.myshopmate.user.Config.BaseURL.USER_CITY;
import static com.myshopmate.user.Config.BaseURL.USER_CURRENCY;
import static com.myshopmate.user.Config.BaseURL.USER_CURRENCY_CNTRY;
import static com.myshopmate.user.Config.BaseURL.USER_EMAIL_SERVICE;
import static com.myshopmate.user.Config.BaseURL.USER_INAPP_SERVICE;
import static com.myshopmate.user.Config.BaseURL.USER_LANG;
import static com.myshopmate.user.Config.BaseURL.USER_LAT;
import static com.myshopmate.user.Config.BaseURL.USER_OTP;
