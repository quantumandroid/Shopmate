...
import static com.myshopmate.user.Config.BaseURL.EditAddress;
        ...
        EditBtn.setOnClickListener(v -> {
            ...
            if (isOnline()) {
                ...
                if (landmaarkkkk != null && !landmaarkkkk.equalsIgnoreCase("")) {
                    ...
                    editAdressURl(addressId, cityName, SocetyName, "NA");
                }
            }
        });
...
//                Log.d("socetyId",houseNo.getText().toString());
    ...
    private void showAdreesUrl() {
        ...
        params.put("store_id", session_management.getStoreId());
