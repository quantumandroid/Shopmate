...
import com.myshopmate.user.Activity.Coupen;
import com.myshopmate.user.Activity.OrderSuccessful;
import com.myshopmate.user.Activity.PaymentGatWay;
import com.myshopmate.user.Activity.Paytm;
...
import com.myshopmate.user.util.NetworkConnection;
...
import static com.myshopmate.user.Config.BaseURL.COUPON_CODE;
import static com.myshopmate.user.Config.BaseURL.Wallet_CHECKOUT;
...
//        });
        ...
        checkBox_Wallet = view.findViewById(R.id.use_wallet);
        checkBox_Wallet.setTypeface(font);
        rb_Store = view.findViewById(R.id.use_store_pickup);
        rb_Store.setTypeface(font);
        rb_Cod = view.findViewById(R.id.use_COD);
        rb_Cod.setTypeface(font);
        rb_card = view.findViewById(R.id.use_card);
        rb_card.setTypeface(font);
        rb_Netbanking = view.findViewById(R.id.use_netbanking);
        rb_Netbanking.setTypeface(font);
        rb_paytm = view.findViewById(R.id.use_wallet_ammount);
        rb_paytm.setTypeface(font);
        checkBox_coupon = view.findViewById(R.id.use_coupon);
        checkBox_coupon.setTypeface(font);
        et_Coupon = view.findViewById(R.id.et_coupon_code);
        Promo_code_layout = view.findViewById(R.id.prommocode_layout);
        Apply_Coupon_Code = view.findViewById(R.id.apply_coupoun_code);
...
//                Coupon_code();
        ...
        Coupon_and_wallet = view.findViewById(R.id.coupon_and_wallet);
        Relative_used_wallet = view.findViewById(R.id.relative_used_wallet);
        Relative_used_coupon = view.findViewById(R.id.relative_used_coupon);

        //Show  Wallet
        getwallet = SharedPref.getString(getActivity(), BaseURL.KEY_WALLET_Ammount);
        my_wallet_ammount = view.findViewById(R.id.user_wallet);
        ...
        order_ammount = view.findViewById(R.id.order_ammount);
        used_wallet_ammount = view.findViewById(R.id.used_wallet_ammount);
        used_coupon_ammount = view.findViewById(R.id.used_coupon_ammount);
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                for (int i = 0; i < Jarray.length(); i++) {
                                    ...
                                    used_wallet_ammount.setText("(" + session_management.getCurrency() + Used_Wallet_amount + ")");
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (obj.optString("responce").equals("true")) {
                                    ...
                                    used_coupon_ammount.setText("(" + session_management.getCurrency() + Used_coupon_amount + ")");
                                    Promo_code_layout.setVisibility(View.GONE);
